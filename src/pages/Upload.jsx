                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted m-0 capitalize">
                                    {activeJob.phase === 'reading'
                                        ...
                                        : activeJob.phase === 'msg_extraction'
                                        ? 'Extracting embedded MSG attachments...'
                                        : activeJob.phase === 'zip_extraction'
                                        ? 'Extracting ZIP attachments...'
                                        : activeJob.phase === 'pdf_portfolio_extraction'
                                        ? 'Extracting PDF portfolio attachments...'
                                        : activeJob.phase === 'tnef_extraction'
                                        ? 'Extracting TNEF/winmail.dat attachments...'
                                        : activeJob.phase === 'recursive_extraction'
                                        ? 'Extracting nested containers...'
